  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center items-start px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center text-gray-400 cursor-pointer hover:text-purple-400 transition-colors duration-300"
      >
