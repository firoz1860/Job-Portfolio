  ...
  const skills = [
    {
      ...
      color: styles.skillOrange,
      level: 90,
    },
    {
      name: "Node.js",
      icon: <Cpu className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillGreen,
      level: 85,
    },
    {
      name: "ReactJS",
      icon: <Code className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillBlue,
      level: 95,
    },
    {
      name: "MongoDB",
      icon: <Database className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillLime,
      level: 80,
    },
    {
      name: "TypeScript",
      icon: <Code className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillIndigo,
      level: 75,
    },
    {
      name: "NextJS",
      icon: <Zap className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillGray,
      level: 88,
    },
    {
      name: "ExpressJS",
      icon: <Globe className="w-4 h-4 sm:w-5 sm:h-5" />,
      color: styles.skillYellow,
      level: 85,
    },
    {
      name: "GIT",
            ...
            >
              ...
              >
                  ...
                  <div className={styles.cardContent}>
                    ...
                    <div className={styles.codeContainer}>
                      <pre className={styles.codeBlock}>
                        <code>
                          <span className={styles.codePurple}>class</span>{" "}
                          <span className={styles.codeCyan}>Developer</span>{" "}
                          <span className={styles.codeWhite}>&#123;</span>
                          {"\n  "}
                          <span className={styles.codePurple}>
                            constructor
                          </span>() <span className={styles.codeWhite}>&#123;</span>
                          {"\n    "}
                          <span className={styles.codeBlue}>this</span>.name ={" "}
                          <span className={styles.codeGreen}>"Firoz Ahmad"</span>;
                          {"\n    "}
                          <span className={styles.codeBlue}>this</span>.role ={" "}
                          <span className={styles.codeGreen}>
                            "Full Stack Developer"
                          </span>
                          ;{"\n    "}
                          <span className={styles.codeBlue}>this</span>.location ={" "}
                          <span className={styles.codeGreen}>"Delhi, India"</span>
                          ;{"\n  "}
                          <span className={styles.codeWhite}>&#125;</span>
                          {"\n\n  "}
                          <span className={styles.codePurple}>
                          ...
                          {"\n    "}
                          <span className={styles.codeYellow}>return</span>{" "}
                          <span className={styles.codeWhite}>&#123;</span>
                          {"\n      "}email:{" "}
                          <span className={styles.codeGreen}>
                          ...
                          <span className={styles.codeWhite}>&#125;</span>
                          {"\n\n  "}
                          <span className={styles.codePurple}>getEducation</span>
                          () <span className={styles.codeWhite}>&#123;</span>
                          {"\n    "}
                          <span className={styles.codeYellow}>return</span>{" "}
                          <span className={styles.codeWhite}>&#123;</span>
                          ...
                          ,{"\n      "}period:{" "}
                          <span className={styles.codeCyan}>"2022 - 2026"</span>,
                          {"\n      "}cgpa:{" "}
                ...
                <div className={styles.cardBack}>
                  <div className={`${styles.cardContent} ${styles.cardContentBack}`}>
                    ...
                    <div className={styles.skillsGrid}>
                      {skills.map((skill, index) => (
                        <div
                          key={skill.name}
                          className={`${styles.skillCard} ${skill.color} ${
                        ...
                        >
                          ...
                          {/* Hover Effect */}
                          <div className={styles.skillHoverEffect}></div>
                        </div>
                      ))}
                    </div>

                    <div className={styles.clickHint}>
                      <div className={`${styles.hintBadge} ${styles.hintBadgeCyan}`}>
                        <div className={`${styles.hintDot} ${styles.hintDotCyan}`}></div>
                        <p className={styles.hintText}>
          ...
          <div className={styles.sidePanel}>
            <div className={styles.sidePanelContent}>
              ...
              <div className={styles.sideCard}>
                ...
                <div className={styles.contactList}>
                  ...
                  <div className={styles.contactItem}>
                    ...
                    <span className={styles.contactText}>+91 9315742128</span>
                  </div>
                  <div className={styles.contactItem}>
                    <MapPin className={styles.contactIcon} />
                    <span className={styles.contactText}>Delhi, India</span>
                  </div>
                </div>
              </div>
              ...
              <div className={`${styles.sideCard} ${styles.sideCardCyan}`}>
                <h3 className={`${styles.cardHeader} ${styles.cardHeaderCyan}`}>
                  <Award className={styles.cardHeaderIcon} />
                  Quick Stats
                </h3>
                <div className={styles.statsGrid}>
                  <div className={`${styles.statCard} ${styles.statCardPurple}`}>
                    <div className={`${styles.statNumber} ${styles.statNumberPurple}`}>
                      8+
                    </div>
                  ...
                  <div className={`${styles.statCard} ${styles.statCardCyan}`}>
                    <div className={`${styles.statNumber} ${styles.statNumberCyan}`}>
                      2026
                    </div>
                  ...
                  <div className={`${styles.statCard} ${styles.statCardPink}`}>
                    <div className={`${styles.statNumber} ${styles.statNumberPink}`}>
                      2+
                    </div>
                    <div className={styles.statLabel}>
                      Years Coding
              ...
              {/* Learning Card */}
              <div className={`${styles.sideCard} ${styles.sideCardGradient}`}>
                <h3 className={`${styles.cardHeader} ${styles.cardHeaderWhite}`}>
                  <Calendar className={styles.cardHeaderIcon} />
                  Currently Learning
                </h3>
                <div className={styles.learningList}>
                  <div className={styles.learningItem}>
                    <div className={`${styles.learningDot} ${styles.learningDotPurple}`}></div>
                    <span className={styles.learningText}>
                      Advanced React Patterns
                    </span>
                  </div>
                  <div className={styles.learningItem}>
                    <div className={`${styles.learningDot} ${styles.learningDotCyan}`}></div>
                    <span className={styles.learningText}>
                      GraphQL & Apollo
                    </span>
                  </div>
                  <div className={styles.learningItem}>
                    <div className={`${styles.learningDot} ${styles.learningDotPink}`}></div>
                    <span className={styles.learningText}>
                      Cloud Architecture
                    </span>
                  </div>
