...
const codeLines = [
  ...
  ['  education: ', '"B.Tech, Delhi Technological University \'26"', ','],
  ['  location: ', '"Delhi, India (IST)"', ','],
  null,
  ['  experience: ', '["AfterQuery", "Handshake AI", "Creative Business Labs"]', ','],
  ['  languages: ', '["Java", "TypeScript", "Python", "C/C++"]', ','],
  ['  backend: ', '["Spring Boot", "Node.js", "FastAPI", "Microservices"]', ','],
  ['  frontend: ', '["React", "Next.js", "Tailwind CSS"]', ','],
  ['  cloud: ', '["AWS", "Docker", "Kafka", "Redis", "PostgreSQL"]', ','],
  ['  ai: ', '["OpenAI", "Gemini", "LangChain", "RAG"]', ','],
  ['  focus: ', '["REST APIs", "Payments", "Scalable systems"]', ','],
  ['  openTo: ', '"SDE roles · global remote"', ','],
  null,
  ['};'],
];
